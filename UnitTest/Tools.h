...
template <> std::wstring Microsoft::VisualStudio::CppUnitTestFramework::ToString( const Math_NS::Vector3L::Type& t ) { return ToString( t.str() ); }
...
template <> std::wstring Microsoft::VisualStudio::CppUnitTestFramework::ToString( const Math_NS::Vector3L& v ) { return ToString( v.x ) + L", " + ToString( v.y ) + L", " + ToString( v.z ); }
